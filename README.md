...
Plugin **rbr-consulting v2.10.2**: il cervello dei consulenti Restaurant Business Revolution.
...
(`extraKnownMarketplaces` con `autoUpdate: true`): ogni nuova versione arriva da sola.

Guida completa: `ONBOARDING.md` nel repo privato rbr-suite (accesso: Marco).
